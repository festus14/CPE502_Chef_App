...
<body>
	...
	<div class="container-fluid chefCo-container">
		...
		<?php endif; ?>
		<form action="<?php echo base_url(); ?>/customer/update/<?php echo $id ?>" method="post">
										...
										<div class="form-group" style="margin:0px;">
											<ul style="text-decoration:none;margin: 0px;padding-left:70px;">
												...
												<li style="display:inline-block;width:70%">
													<input type="text" style="display:inline-block;" class="form-control form-control-sm  shadow-none my-3" placeholder="Email" readonly value="<?php echo session()->get('email') ?>" />
												</li>
											</ul>
										</div>
									</div>
							...
							<div class="basic-details-sm" style="width:100%; max-width: 794px;">
								<div class="theform" style="padding-bottom: 20px;">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control shadow-none" name="address" placeholder="Address" value="<?php echo $address ?>">
									</div>
