                        ...
                        <div class="col-md-12 d-flex justify-content-center align-items-center joint-tab">
                            <div class="row flex-nowrap">
                                <ul class="nav nav-pills mb-3 -container">
                                    ...
                                    <li class="nav-item chefco-tab">
                                        <a class="nav-link" href="/assets/">Recipes</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
								...
								<div class="container-fluid">
									...
									<div class="container mt-3">
										<div class="row mb-5">
											...
											<div class="col-md-7">          
												<a class="modal-item-h2 mb-0" style="color:#022b69;" href="/assets/order-details.html">Orders by <span>Shola</span></a>
										...
										<div class="row mt-5">
											...
											<div class="col-md-7">  
												<a class="modal-item-h2 mb-0" style="color:#022b69;" href="/assets/order-details.html">Orders by <span>Lara</span></a>        
												<div class="d-flex">
													<span><i class="fa fa-clock-o" style="padding: 8px 8px 8px 0px;"></i></span>
