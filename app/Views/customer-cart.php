...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-custom-2 fixed-top">
		<div class="container" style="padding-left:0px;padding-right:0px;flex-wrap:nowrap;">
			<a class="navbar-brand logo" href="<?php echo base_url(); ?>/">ChefCorner</a>
	...
	<div class="container-fluid chefCo-container">
		...
		<div class="row" style="margin-top: 60px; margin-bottom: 100px;">
			<div class="container">
				<div class="col-md-9">
					<h1 style="padding:0px;margin:0px;">Cart</h1>
				</div>
				<div class="row">
					<div class="col-md-9">
						<div class="container-fluid">
							...
							<?php if (!empty(session()->cart)) : ?>
								<?php foreach (session()->cart as $id => $meal) { ?>
									<div class="row headings x-headings-2">
										...
										<div class="col-lg-3 col-6">
											<ul class="nav">
												<li class="nav-item">
													<span class="cart-row">
														<h5 style="font-weight:bold;"><?php echo $meal['name'] ?></h5>
														<div class="d-flex">
										...
										<div class="col-lg-4 col-6 me">
											<ul class="nav" style="flex-wrap: nowrap;">
												<li class="nav-item">
													<span class="cart-row" style="width:70px;">N<?php echo $meal['price'] ?></span>
												</li>
												<li class="nav-item">
													<span class="cart-row" style="width:70px;"><input type="" name="" style="width:60px;" /></span>
												</li>
												<li class="nav-item">
													<img src="/assets/images/cancel.svg" style="position:absolute;right:0px;top:13px;width:15px;height: 15px;" />
													<span class="cart-row" style="width:70px;">N<?php echo ($meal['price'] * 2) ?></span>
												</li>
											</ul>
										</div>
									</div>
